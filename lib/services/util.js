...
let numRequests = 0;
const auth = 'Basic ' + new Buffer(process.env.ELASTICIO_API_USERNAME + ':' + process.env.ELASTICIO_API_KEY).toString('base64');
...
function downloadAttachment(url) {
    return eioRequest('GET', url, {baseUrl: null, json: false, encoding: null});
}